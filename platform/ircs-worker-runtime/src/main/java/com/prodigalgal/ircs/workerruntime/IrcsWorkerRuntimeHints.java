...
public class IrcsWorkerRuntimeHints implements RuntimeHintsRegistrar {
    ...
    private static final String[] WORKER_JSON_BINDING_TYPES = {
    ...
    public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
        ...
        registerJsonBindingHints(hints, WORKER_JSON_BINDING_TYPES);
    }
