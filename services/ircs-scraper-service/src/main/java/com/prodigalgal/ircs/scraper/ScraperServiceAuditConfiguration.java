...
@Configuration
class ScraperServiceAuditConfiguration {
    ...
    FilterRegistrationBean<ServiceRequestAuditFilter> serviceRequestAuditFilter(
            ...
            @Value("${app.service.audit.source:${spring.application.name:ircs-scraper-service}}") String requestSource) {
    ...
    WorkerJobAuditWriter workerJobAuditWriter(
            ...
            @Value("${app.worker.audit.source:${spring.application.name:ircs-scraper-service}}") String jobSource) {
