...
@Configuration
class StorageServiceAuditConfiguration {
    ...
    FilterRegistrationBean<ServiceRequestAuditFilter> serviceRequestAuditFilter(
            ...
            @Value("${app.service.audit.source:${spring.application.name:ircs-storage-service}}") String requestSource) {
    ...
    WorkerJobAuditWriter workerJobAuditWriter(
            ...
            @Value("${app.worker.audit.source:${spring.application.name:ircs-storage-service}}") String jobSource) {
