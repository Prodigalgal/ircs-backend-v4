...
class StorageConfigEventTopologyTest {

    @Test
    void declaresDedicatedStorageConfigChangedQueue() {
        Declarables declarables = new StorageConfigEventTopology().storageConfigChangedTopology();
