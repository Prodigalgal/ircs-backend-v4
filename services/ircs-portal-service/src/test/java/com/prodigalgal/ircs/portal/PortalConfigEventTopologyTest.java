...
class PortalConfigEventTopologyTest {

    @Test
    void declaresDedicatedPortalConfigChangedQueue() {
        Declarables declarables = new PortalConfigEventTopology().portalConfigChangedTopology();
