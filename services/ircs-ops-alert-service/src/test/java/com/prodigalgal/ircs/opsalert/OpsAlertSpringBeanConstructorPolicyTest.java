...
class OpsAlertSpringBeanConstructorPolicyTest {
    ...
    void springBeansUseSingleConstructorAndNoAutowiredInjectionPoints() throws Exception {
        ...
        for (Class<?> beanClass : opsAlertClasses()) {
    ...
    private static List<Class<?>> opsAlertClasses() throws Exception {
        PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        MetadataReaderFactory metadataReaderFactory = new CachingMetadataReaderFactory(resolver);
        Resource[] resources = resolver.getResources("classpath*:com/prodigalgal/ircs/opsalert/**/*.class");
