...
class InteractionConfigEventTopologyTest {

    @Test
    void bindsInteractionConfigQueueToDomainEventRoutingKey() {
        var declarables = new InteractionConfigEventTopology().interactionConfigChangedTopology().getDeclarables();
