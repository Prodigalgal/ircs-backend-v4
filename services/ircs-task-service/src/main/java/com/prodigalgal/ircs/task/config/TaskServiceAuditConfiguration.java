...
@Configuration
class TaskServiceAuditConfiguration {
    ...
    FilterRegistrationBean<ServiceRequestAuditFilter> serviceRequestAuditFilter(
            ...
            @Value("${app.service.audit.source:${spring.application.name:ircs-task-service}}") String requestSource) {
    ...
    WorkerJobAuditWriter workerJobAuditWriter(
            ...
            @Value("${app.worker.audit.source:${spring.application.name:ircs-task-service}}") String jobSource) {
