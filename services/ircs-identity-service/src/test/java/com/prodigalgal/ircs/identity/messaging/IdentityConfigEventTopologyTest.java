...
class IdentityConfigEventTopologyTest {

    @Test
    void bindsIdentityConfigQueueToDomainEventRoutingKey() {
        var declarables = new IdentityConfigEventTopology().identityConfigChangedTopology().getDeclarables();
