...
class ContentConfigEventTopologyTest {

    @Test
    void bindsContentConfigQueueToDomainEventRoutingKey() {
        var declarables = new ContentConfigEventTopology().contentConfigChangedTopology().getDeclarables();
