...
class NotificationConfigEventTopologyTest {

    @Test
    void declaresDedicatedNotificationConfigChangedQueue() {
        Declarables declarables = new NotificationConfigEventTopology().notificationConfigChangedTopology();
