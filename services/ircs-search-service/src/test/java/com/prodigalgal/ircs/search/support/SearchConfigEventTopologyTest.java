...
class SearchConfigEventTopologyTest {

    @Test
    void bindsSearchConfigQueueToDomainEventRoutingKey() {
        var declarables = new SearchConfigEventTopology().searchConfigChangedTopology().getDeclarables();
