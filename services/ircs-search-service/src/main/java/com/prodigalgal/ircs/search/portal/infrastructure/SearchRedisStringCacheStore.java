package com.prodigalgal.ircs.search.portal.infrastructure;
...
public class SearchRedisStringCacheStore implements TieredStringCacheStore {

    private final StringRedisTemplate redisTemplate;

    public SearchRedisStringCacheStore(StringRedisTemplate redisTemplate) {
