...
@Configuration
class SearchServiceAuditConfiguration {
    ...
    FilterRegistrationBean<ServiceRequestAuditFilter> serviceRequestAuditFilter(
            ...
            @Value("${app.service.audit.source:${spring.application.name:ircs-search-service}}") String requestSource) {
    ...
    WorkerJobAuditWriter workerJobAuditWriter(
            ...
            @Value("${app.worker.audit.source:${spring.application.name:ircs-search-service}}") String jobSource) {
